...
"23" => "ファイル",
"24" => "親フォルダ",
"25" => "ファイル(複数可 - 上限 ". \Pydio\Core\Services\ConfService::getConf('UPLOAD_MAX_NUMBER')." 個まで) を次のフォルダにアップロード : ",
"26" => "新しいフォルダを作成 : ",
"27" => "アップロード(U)",
"28" => "新しいファイルを作成 : ",
"29" => "作成",
"30" => "フォルダ名を記入して '作成' をクリックしてください",
"31" => "ファイルを選択してください",
"32" => "閲覧",
"33" => "ファイルのアップロードに失敗 !",
"34" => "ファイル",
...
"38" => "フォルダ",
"39" => "が作成されました",
"40" => "このフォルダは既に存在しています (名前の大文字・小文字は区別されません)",
"41" => "は次の通り名前が変更されました",
"42" => "へ",
